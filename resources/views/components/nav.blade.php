<nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 bg-light opacity-85"
    ...
    <div class="container">
        <a class="navbar-brand" href="/">
            <img class="d-inline-block align-top img-fluid" src="{{asset('assets/img/gallery/logo-icon.png')}}" alt="" width="50"/>
        ...
        <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item px-2"><a class="nav-link fw-medium" href="#Features">Features</a></li>
                <li class="nav-item px-2"><a class="nav-link fw-medium" href="#benefit">Benefit</a></li>
            </ul>
            <a href="/farmHerd" class="d-flex">
